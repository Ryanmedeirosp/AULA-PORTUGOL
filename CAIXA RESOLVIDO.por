programa
{
	...
	funcao processa_saque(inteiro valor_saque)
	{
		...
		notas_50 = valor_saque / 50 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 20
		notas_10 = valor_saque / 100
		}
		se(valor_saque == 50){
		notas_50 = valor_saque / 50 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 200
		notas_10 = valor_saque / 100
		}
		se(valor_saque == 100){
		notas_50 = valor_saque / 50 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 200
		notas_10 = valor_saque / 1000
		}
		se(valor_saque == 150){
		notas_50 = valor_saque / 75 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 75
		notas_10 = valor_saque / 150
		}
		se(valor_saque == 180){
		notas_50 = valor_saque / 50 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 180
		notas_10 = valor_saque / 180
		}
		se(valor_saque == 240){
		notas_50 = valor_saque / 80 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 80
		notas_10 = valor_saque / 80
		}
		se(valor_saque == 320){
		notas_50 = valor_saque / 60 // siga esta ideia para programar as duas linhas abaixo
		notas_20 = valor_saque / 100
		notas_10 = valor_saque / 320
		}
	}
